...
/**
 * Autonomous program that drives the robot to the gear station, then 
 * presses the hopper button in order to store fuel into the robot.
 * <p>
 * Commands are called to perform all the necessary movements of the robot
...
public class AutonHopper extends CommandGroup {
	 ...
	 *   <li>Robot turns around so it is facing opposite than it originally was</li>
